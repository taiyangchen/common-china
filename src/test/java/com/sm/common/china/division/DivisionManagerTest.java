 ...
 */
public class DivisionManagerTest extends LoggerSupport {
  ...
  public void getDivisionByTName() {
    assertEquals(((ChinaDivision) divisionManager.getDivisionByTName("澳門特別行政區").get(0)).getDivisionTname(), "澳門特別行政區");
  }
